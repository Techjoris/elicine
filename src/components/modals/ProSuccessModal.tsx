  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative bg-white dark:bg-[#07090e] border border-amber-500/40 rounded-3xl p-6 sm:p-9 space-y-6 shadow-2xl text-slate-800 dark:text-slate-100">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              ...
              <div className="relative w-24 h-24 rounded-3xl bg-gradient-to-tr from-amber-400 via-yellow-300 to-amber-500 p-0.5 shadow-md">
                <div className="w-full h-full bg-amber-50 dark:bg-[#07090e] rounded-[22px] flex items-center justify-center">
                  <Crown className="w-11 h-11 text-amber-500 dark:text-amber-400 fill-amber-500/20 dark:fill-amber-400/30" />
                </div>
              </div>
              {/* Orbiting sparkles */}
            ...
            {/* Pro badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-500/15 to-sky-500/15 border border-amber-500/40 text-amber-700 dark:text-amber-300 text-xs font-black uppercase tracking-widest shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
            {[
              ...
              <div
                key={label}
                className={`flex items-center gap-2.5 p-3 rounded-2xl border ${color} text-xs font-semibold text-slate-700 dark:text-slate-200`}
              >
                {icon}
                <span>{label}</span>
              </div>
