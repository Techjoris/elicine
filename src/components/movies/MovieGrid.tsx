...
export const MovieGrid: React.FC<MovieGridProps> = ({
  ...
  return (
    <section id="results-section" className="w-full space-y-5">
      ...
      {/* AI Thought Banner */}
      {aiThought && (
        <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-blue-950/60 via-[#0f141f] to-slate-900 border border-[#1e293b] shadow-neon-blue space-y-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2">
        ...
        <span className="text-xs px-3 py-1 rounded-full bg-slate-900 border border-[#1e293b] text-slate-400 font-semibold self-start sm:self-auto">
      ...
      {movies.length === 0 && !isLoadingMore ? (
        <div className="text-center py-16 px-4 rounded-2xl bg-[#0f141f] border border-[#1e293b]">
          <p className="text-slate-300 font-semibold text-sm">Aucun résultat trouvé pour cette recherche.</p>
        </div>
      ) : (
