      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-3xl mx-auto my-auto w-full">
        ...
        <div className="w-full max-w-2xl mx-auto flex flex-col gap-1.5">
          <form 
            ...
            className="relative flex items-end min-h-[48px] w-full rounded-xl sm:rounded-2xl border border-white/15 bg-zinc-950/85 backdrop-blur-2xl px-3 py-1.5 shadow-2xl focus-within:border-white/40 transition-all"
          >
            {/* Search icon */}
            ...
            <div className="flex items-center gap-2 flex-shrink-0 self-end mb-0.5 sm:mb-1">
              ...
              {searchPrompt.length >= 280 && (
                <span
                  ...
                  title={`${350 - searchPrompt.length} caractères restants (limite : 350)`}
                >
                  {350 - searchPrompt.length}
                </span>
              )}
