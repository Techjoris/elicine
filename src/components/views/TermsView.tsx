...
export const TermsView: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-6 sm:py-10 px-2 sm:px-4 text-zinc-300 space-y-12 animate-fade-in font-sans selection:bg-zinc-700 selection:text-white">
      ...
      <div className="flex items-center justify-between border-b border-white/5 pb-5">
        <button
          ...
          className="inline-flex items-center gap-1.5 text-xs text-zinc-400 hover:text-white transition-colors cursor-pointer select-none group"
        >
      ...
      <header className="space-y-4">
        ...
        <div className="pt-2 space-y-3 text-sm text-zinc-300 leading-relaxed">
          <p>
            Les présentes Conditions Générales d'Utilisation et de Confidentialité (ci-après les « CGU ») encadrent juridiquement l'accès et l'utilisation de la plateforme numérique et application web progressive (PWA) Éliciné (ci-après le « Service »), accessible à l'adresse officielle <a href="https://elicine.app" target="_blank" rel="noopener noreferrer" className="text-zinc-100 underline underline-offset-2 hover:text-white">https://elicine.app</a> ainsi que sur tous ses sous-domaines associés.
          </p>
      ...
      {/* 3. Document éditorial continu (Articles 1 à 9) */}
      <main className="space-y-10 divide-y divide-white/5">
        ...
        <article className="pt-10 first:pt-0 space-y-4">
          ...
          <ul className="space-y-2 text-sm text-zinc-300 leading-relaxed list-disc pl-5 marker:text-zinc-500">
            <li>
              <strong>Dénomination du service :</strong> Éliciné
            </li>
            <li>
              <strong>Site officiel :</strong> <a href="https://elicine.app" target="_blank" rel="noopener noreferrer" className="text-zinc-100 underline underline-offset-2 hover:text-white">https://elicine.app</a>
            </li>
            <li>
              <strong>Contact support &amp; réclamations :</strong> <a href="mailto:contact@elicine.app" className="text-zinc-100 underline underline-offset-2 hover:text-white">contact@elicine.app</a>
            </li>
            <li>
              <strong>Délégué à la protection des données (DPO / Privacy) :</strong> <a href="mailto:support@elicine.app" className="text-zinc-100 underline underline-offset-2 hover:text-white">support@elicine.app</a>
            </li>
            <li>
              <strong>Hébergement et infrastructures réseau :</strong> Serveurs cloud distribués haute disponibilité et protocoles de chiffrement SSL/TLS de bout en bout.
            </li>
            <li>
              <strong>Base de données et gestion de sessions :</strong> Infrastructure gérée par Supabase (serveurs certifiés ISO 27001 et SOC 2 Type II).
            </li>
            <li>
              <strong>Fournisseur de métadonnées cinématographiques :</strong> Métadonnées, résumés, crédits artistiques et affiches mis à disposition via l'API The Movie Database (TMDB).
            </li>
          </ul>
        </article>
        ...
        <article className="pt-10 space-y-4">
          ...
          <div className="space-y-3 text-sm text-zinc-300 leading-relaxed">
            ...
            <ul className="space-y-2 list-disc pl-5 marker:text-zinc-500">
        ...
        <article className="pt-10 space-y-4">
          ...
          <div className="space-y-4 text-sm text-zinc-300 leading-relaxed">
            ...
            <div className="space-y-2 pt-2">
              ...
              <ol className="space-y-1.5 list-decimal pl-5 marker:text-zinc-500">
        ...
        <article className="pt-10 space-y-4">
          ...
          <div className="space-y-4 text-sm text-zinc-300 leading-relaxed">
            ...
            <div className="space-y-2 pt-2">
              ...
              <ul className="space-y-2 list-disc pl-5 marker:text-zinc-500">
                <li>
                  Éliciné ne stocke, ne voit et n'archive aucun numéro de carte de paiement, cryptogramme visuel ou code secret bancaire.
                </li>
                <li>
        ...
        <article className="pt-10 space-y-4">
          ...
          <div className="space-y-3 text-sm text-zinc-300 leading-relaxed">
            <div className="space-y-1.5">
              ...
              <p>
                L'appellation Éliciné, le nom de domaine <a href="https://elicine.app" target="_blank" rel="noopener noreferrer" className="text-zinc-100 underline underline-offset-2 hover:text-white">https://elicine.app</a>, l'architecture logicielle, le design visuel, l'expérience utilisateur et les algorithmes développés en interne sont la propriété exclusive de l'éditeur et protégés par le droit d'auteur et les lois sur la propriété intellectuelle.
              </p>
            </div>
        ...
        <article className="pt-10 space-y-4">
          ...
          <div className="space-y-3 text-sm text-zinc-300 leading-relaxed">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-zinc-500">
              <li>
                <strong>Par email à :</strong> <a href="mailto:support@elicine.app" className="text-zinc-100 underline underline-offset-2 hover:text-white">support@elicine.app</a> ou <a href="mailto:contact@elicine.app" className="text-zinc-100 underline underline-offset-2 hover:text-white">contact@elicine.app</a>
              </li>
              <li>
        ...
        <article className="pt-10 space-y-4">
          ...
          <p className="text-sm text-zinc-300 leading-relaxed">
            Éliciné se réserve la possibilité d'adapter et de mettre à jour les présentes CGU pour refléter les évolutions fonctionnelles, techniques ou légales du Service. La version en vigueur est celle consultable en permanence à l'adresse : <a href="https://elicine.app/terms" target="_blank" rel="noopener noreferrer" className="text-zinc-100 underline underline-offset-2 hover:text-white">https://elicine.app/terms</a>.
          </p>
        </article>
      ...
      <div className="pt-8 border-t border-white/5 flex items-center justify-between text-xs text-zinc-500">
        <button
          type="button"
          onClick={handleBackToApp}
          className="inline-flex items-center gap-1.5 text-zinc-400 hover:text-white transition-colors cursor-pointer select-none group"
        >
          <ArrowLeft className="w-3.5 h-3.5 group-hover:-translate-x-0.5 transition-transform" />
