...
export const WatchlistView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="p-6 rounded-3xl bg-gradient-to-r from-emerald-950/40 via-slate-900 to-slate-900 border border-emerald-500/20">
      ...
      {watchlist.length === 0 ? (
        <div className="text-center py-20 px-4 rounded-3xl bg-slate-900/40 border border-slate-800 space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">Votre liste est vide pour l'instant</h3>
