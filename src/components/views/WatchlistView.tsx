...
export const WatchlistView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {watchlist.length === 0 ? (
        <div className="text-center py-20 px-4 rounded-2xl bg-[#121212] border border-white/10 space-y-4">
          <Film className="w-12 h-12 text-zinc-600 mx-auto" />
          <h3 className="text-lg font-bold text-white uppercase tracking-tight">Votre liste est vide pour l'instant</h3>
