...
const baseTranslations: Record<Language, TranslationSchema> = {
  fr: {
    ...
    vpnNeededTitle: "Disponible dans d’autres régions",
    vpnNeededDesc: "Les catalogues varient selon votre localisation.",
    vpnButton: "Découvrir",
    vpnTravelTitle: "Vous voyagez ?",
    vpnTravelText: "Gardez une connexion privée et sécurisée.",
    privateConnectionTitle: "Connexion privée en déplacement",
    privateConnectionText: "Protégez vos données sur les réseaux publics et lors de vos voyages.",
  ...
  en: {
    ...
    vpnNeededTitle: "Available in other regions",
    vpnNeededDesc: "Catalogues vary depending on your location.",
    vpnButton: "Discover",
    vpnTravelTitle: "Travelling?",
    vpnTravelText: "Keep a private, secure connection.",
    privateConnectionTitle: "Private connection while travelling",
    privateConnectionText: "Protect your data on public networks and during your travels.",
  ...
  es: {
    ...
    vpnNeededTitle: "Disponible en otras regiones",
    vpnNeededDesc: "Los catálogos varían según tu ubicación.",
    vpnButton: "Descubrir",
    vpnTravelTitle: "¿Estás de viaje?",
    vpnTravelText: "Mantén una conexión privada y segura.",
    privateConnectionTitle: "Conexión privada en desplazamiento",
    privateConnectionText: "Protege tus datos en redes públicas y durante tus viajes.",
  ...
  de: {
    ...
    vpnNeededTitle: "In anderen Regionen verfügbar",
    vpnNeededDesc: "Die Kataloge variieren je nach Standort.",
    vpnButton: "Entdecken",
    vpnTravelTitle: "Sie sind unterwegs?",
    vpnTravelText: "Bleiben Sie privat und sicher verbunden.",
    privateConnectionTitle: "Private Verbindung unterwegs",
    privateConnectionText: "Schützen Sie Ihre Daten in öffentlichen Netzen und auf Reisen.",
  ...
  it: {
    ...
    vpnNeededTitle: "Disponibile in altre regioni",
    vpnNeededDesc: "I cataloghi variano in base alla tua posizione.",
    vpnButton: "Scopri",
    vpnTravelTitle: "Sei in viaggio?",
    vpnTravelText: "Mantieni una connessione privata e sicura.",
    privateConnectionTitle: "Connessione privata in viaggio",
    privateConnectionText: "Proteggi i tuoi dati sulle reti pubbliche e durante i viaggi.",
