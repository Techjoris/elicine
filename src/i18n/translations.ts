...
export interface TranslationSchema {
  ...
  vpnButton: string;
  vpnTravelTitle: string;
  vpnTravelText: string;
  privateConnectionTitle: string;
  privateConnectionText: string;
  privateConnectionCta: string;
...
const baseTranslations: Record<Language, TranslationSchema> = {
  fr: {
    ...
    vpnNeededTitle: "Disponibilité selon votre région",
    vpnNeededDesc: "Les catalogues varient selon votre localisation.",
    vpnButton: "Voir l’option de connexion privée",
    vpnTravelTitle: "Accès selon votre localisation",
    vpnTravelText: "Le catalogue affiché dépend de votre pays. Une connexion privée peut être utile lors d’un déplacement ou d’un séjour à l’étranger.",
    privateConnectionTitle: "Connexion privée en déplacement",
    privateConnectionText: "Protégez vos données sur les réseaux publics et lors de vos déplacements à l’étranger.",
    privateConnectionCta: "Voir la solution recommandée",
    affiliateDisclosure: "Certains liens externes peuvent soutenir Éliciné sans coût supplémentaire pour vous.",
  ...
  en: {
    ...
    vpnNeededTitle: "Availability by region",
    vpnNeededDesc: "Catalogues vary depending on your location.",
    vpnButton: "View the private connection option",
    vpnTravelTitle: "Access based on your location",
    vpnTravelText: "The catalogue shown depends on your country. A private connection can be useful when travelling or staying abroad.",
    privateConnectionTitle: "Private connection while travelling",
    privateConnectionText: "Protect your data on public networks and while travelling abroad.",
    privateConnectionCta: "View the recommended solution",
    affiliateDisclosure: "Some external links may support Éliciné at no extra cost to you.",
  ...
  es: {
    ...
    vpnNeededTitle: "Disponibilidad según tu región",
    vpnNeededDesc: "Los catálogos varían según tu ubicación.",
    vpnButton: "Ver la opción de conexión privada",
    vpnTravelTitle: "Acceso según tu ubicación",
    vpnTravelText: "El catálogo mostrado depende de tu país. Una conexión privada puede ser útil durante un viaje o una estancia en el extranjero.",
    privateConnectionTitle: "Conexión privada en desplazamiento",
    privateConnectionText: "Protege tus datos en redes públicas y durante tus desplazamientos al extranjero.",
    privateConnectionCta: "Ver la solución recomendada",
    affiliateDisclosure: "Algunos enlaces externos pueden apoyar a Éliciné sin coste adicional para ti.",
  ...
  de: {
    ...
    vpnNeededTitle: "Verfügbarkeit je nach Region",
    vpnNeededDesc: "Die Kataloge variieren je nach Standort.",
    vpnButton: "Private Verbindungsoption ansehen",
    vpnTravelTitle: "Zugriff je nach Standort",
    vpnTravelText: "Der angezeigte Katalog hängt von Ihrem Land ab. Eine private Verbindung kann auf Reisen oder bei einem Auslandsaufenthalt hilfreich sein.",
    privateConnectionTitle: "Private Verbindung unterwegs",
    privateConnectionText: "Schützen Sie Ihre Daten in öffentlichen Netzen und auf Reisen ins Ausland.",
    privateConnectionCta: "Empfohlene Lösung ansehen",
    affiliateDisclosure: "Einige externe Links können Éliciné ohne zusätzliche Kosten für Sie unterstützen.",
  ...
  it: {
    ...
    vpnNeededTitle: "Disponibilità in base alla tua regione",
    vpnNeededDesc: "I cataloghi variano in base alla tua posizione.",
    vpnButton: "Vedi l’opzione di connessione privata",
    vpnTravelTitle: "Accesso in base alla tua posizione",
    vpnTravelText: "Il catalogo mostrato dipende dal tuo Paese. Una connessione privata può essere utile in viaggio o durante un soggiorno all’estero.",
    privateConnectionTitle: "Connessione privata in viaggio",
    privateConnectionText: "Proteggi i tuoi dati sulle reti pubbliche e durante i viaggi all’estero.",
    privateConnectionCta: "Vedi la soluzione consigliata",
    affiliateDisclosure: "Alcuni link esterni possono sostenere Éliciné senza costi aggiuntivi per te.",
