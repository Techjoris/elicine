      ...
      blocks: [
        {
          ...
          items: [
            { label: "Cuotas de IA ilimitadas", text: "Acceso continuo y sin restricciones diarias al motor de inteligencia artificial CinéIA para recomendaciones y análisis personalizados." },
